...
const mockBusinesses = [
  { id: '1', name: 'TechCorp Solutions', email: 'contact@techcorp.com', type: 'business' },
  { id: '2', name: 'Global Retail Co', email: 'info@globalretail.com', type: 'business' },
  { id: '3', name: 'Digital Marketing Pro', email: 'hello@digitalmarketing.com', type: 'business' },
  { id: '4', name: 'StartupXYZ', email: 'team@startupxyz.com', type: 'business' },
  { id: '5', name: 'Creative Solutions', email: 'support@creativesolutions.com', type: 'business' },
];

const mockUsers = [
  { id: '1', name: 'John Smith', email: 'john.smith@email.com', type: 'user', business: 'TechCorp Solutions' },
  { id: '2', name: 'Sarah Johnson', email: 'sarah.johnson@email.com', type: 'user', business: 'Global Retail Co' },
  { id: '3', name: 'Mike Wilson', email: 'mike.wilson@email.com', type: 'user', business: 'Digital Marketing Pro' },
  { id: '4', name: 'Emily Davis', email: 'emily.davis@email.com', type: 'user', business: 'StartupXYZ' },
            ...
            <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-80 overflow-y-auto">
              {searchResults.map((item) => {
                ...
                const getItemSubtext = () => {
                  if (role === 'superadmin') {
                    return item.type === 'business' ? item.email : `${item.email} • ${item.business}`;
                  } else {
                    switch (item.type) {
