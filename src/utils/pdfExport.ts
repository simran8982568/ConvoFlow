...
export const generateDashboardPDF = async (data: DashboardData): Promise<Blob> => {
  ...
  const htmlContent = `
    ...
    <body>
      <div class="header">
        <h1>ConvoFlow Dashboard Report</h1>
      ...
      <div class="footer">
        <p>This report was generated by ConvoFlow Dashboard Export Feature</p>
        <p>For support, contact: support@convoflow.com</p>
      </div>
    </body>
    </html>
  `;
...
${'='.repeat(50)}
Report generated by ConvoFlow Dashboard
For support: support@convoflow.com
  `;
